...
?>
                    ...
                    <div class="page-header-content">
                        <div class="page-header-content-inner">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="current"><a href="rrethnesh.php">Reth nesh</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="need-help-area bg-img sm-top" data-bg="assets/img/bg/bg-222.jpg">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-7 text-center text-sm-start">
                    <div class="need-help-content mb-sm-20">
                        <h3>Keni nevoje për diqka ?</h3>
                        <p>Na kontaktoni ne +355 68 204 2503</p>
                    </div>
                </div>

                <div class="col-sm-5 text-center text-sm-end">
                    <a href="kontakt.php" class="btn btn-black">Na kontaktoni</a>
                </div>
            </div>
        </div>
    </div>
