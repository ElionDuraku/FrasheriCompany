                ...
                <div class="row mtn-40">
                    ...
                    <div class="col-sm-6 col-lg-2">
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <ul class="widget-list">
                                    <li><a href="produktet.php">Pjese elektrike</a></li>
                                    <li><a href="produktet.php">Pjese pneumatike</a></li>
                                    <li><a href="produktet.php">Pjese mekanike</a></li>
                                    <li><a href="produktet.php">Pjese hidraulike</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
